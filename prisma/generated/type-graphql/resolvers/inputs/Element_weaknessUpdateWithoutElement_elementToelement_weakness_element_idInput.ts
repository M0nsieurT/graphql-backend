...
@TypeGraphQL.InputType("Element_weaknessUpdateWithoutElement_elementToelement_weakness_element_idInput", {
  isAbstract: true
})
export class Element_weaknessUpdateWithoutElement_elementToelement_weakness_element_idInput {
