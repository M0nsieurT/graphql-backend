...
@TypeGraphQL.InputType("Element_affinityUpsertWithWhereUniqueWithoutElement_elementToelement_affinity_element_idInput", {
  isAbstract: true
})
export class Element_affinityUpsertWithWhereUniqueWithoutElement_elementToelement_affinity_element_idInput {
