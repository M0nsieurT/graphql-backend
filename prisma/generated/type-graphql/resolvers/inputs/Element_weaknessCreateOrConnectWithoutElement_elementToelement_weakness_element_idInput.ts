...
@TypeGraphQL.InputType("Element_weaknessCreateOrConnectWithoutElement_elementToelement_weakness_element_idInput", {
  isAbstract: true
})
export class Element_weaknessCreateOrConnectWithoutElement_elementToelement_weakness_element_idInput {
