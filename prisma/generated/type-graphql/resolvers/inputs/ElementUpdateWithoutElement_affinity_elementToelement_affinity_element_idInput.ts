...
@TypeGraphQL.InputType("ElementUpdateWithoutElement_affinity_elementToelement_affinity_element_idInput", {
  isAbstract: true
})
export class ElementUpdateWithoutElement_affinity_elementToelement_affinity_element_idInput {
