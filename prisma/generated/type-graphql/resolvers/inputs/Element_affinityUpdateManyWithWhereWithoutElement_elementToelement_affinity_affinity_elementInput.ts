...
@TypeGraphQL.InputType("Element_affinityUpdateManyWithWhereWithoutElement_elementToelement_affinity_affinity_elementInput", {
  isAbstract: true
})
export class Element_affinityUpdateManyWithWhereWithoutElement_elementToelement_affinity_affinity_elementInput {
