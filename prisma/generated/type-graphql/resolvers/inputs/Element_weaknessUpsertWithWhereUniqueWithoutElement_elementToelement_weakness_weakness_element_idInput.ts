...
@TypeGraphQL.InputType("Element_weaknessUpsertWithWhereUniqueWithoutElement_elementToelement_weakness_weakness_element_idInput", {
  isAbstract: true
})
export class Element_weaknessUpsertWithWhereUniqueWithoutElement_elementToelement_weakness_weakness_element_idInput {
