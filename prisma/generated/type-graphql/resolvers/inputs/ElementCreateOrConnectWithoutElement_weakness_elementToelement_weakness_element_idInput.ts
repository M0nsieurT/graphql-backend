...
@TypeGraphQL.InputType("ElementCreateOrConnectWithoutElement_weakness_elementToelement_weakness_element_idInput", {
  isAbstract: true
})
export class ElementCreateOrConnectWithoutElement_weakness_elementToelement_weakness_element_idInput {
