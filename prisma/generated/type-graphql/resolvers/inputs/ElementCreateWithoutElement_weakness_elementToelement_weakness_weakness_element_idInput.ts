...
@TypeGraphQL.InputType("ElementCreateWithoutElement_weakness_elementToelement_weakness_weakness_element_idInput", {
  isAbstract: true
})
export class ElementCreateWithoutElement_weakness_elementToelement_weakness_weakness_element_idInput {
