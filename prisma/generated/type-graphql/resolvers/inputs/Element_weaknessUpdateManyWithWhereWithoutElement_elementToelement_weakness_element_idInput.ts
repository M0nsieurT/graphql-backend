...
@TypeGraphQL.InputType("Element_weaknessUpdateManyWithWhereWithoutElement_elementToelement_weakness_element_idInput", {
  isAbstract: true
})
export class Element_weaknessUpdateManyWithWhereWithoutElement_elementToelement_weakness_element_idInput {
