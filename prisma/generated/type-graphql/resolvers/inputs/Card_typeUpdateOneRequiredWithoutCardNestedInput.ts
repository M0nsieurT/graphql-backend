...
import { Card_typeUpsertWithoutCardInput } from "../inputs/Card_typeUpsertWithoutCardInput";
import { Card_typeWhereUniqueInput } from "../inputs/Card_typeWhereUniqueInput";

@TypeGraphQL.InputType("Card_typeUpdateOneRequiredWithoutCardNestedInput", {
  isAbstract: true
})
export class Card_typeUpdateOneRequiredWithoutCardNestedInput {
  ...
  @TypeGraphQL.Field(_type => Card_typeUpsertWithoutCardInput, {
    nullable: true
  })
  upsert?: Card_typeUpsertWithoutCardInput | undefined;
  ...
  update?: Card_typeUpdateWithoutCardInput | undefined;
}
