...
@TypeGraphQL.InputType("ElementCreateWithoutElement_affinity_elementToelement_affinity_element_idInput", {
  isAbstract: true
})
export class ElementCreateWithoutElement_affinity_elementToelement_affinity_element_idInput {
